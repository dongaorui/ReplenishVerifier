...
| --- | ---: |
| ReplenishVerifier-Full | 0.8300 |
| ReplenishVerifier-FullV2 | 0.8300 |
...
| Full objective errors | 17 |
| Full errors with an objective-correct candidate in pool | 3 |
| ... distinguishable by non-reference signals | 0 |
| ... only distinguishable by oracle/reference | 3 |
| Full errors with no objective-correct candidate in pool (pool-limited) | 14 |

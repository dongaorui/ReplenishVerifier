...
- Best-of-K, ReplenishVerifier-ConsensusSafe, ReplenishVerifier-Full, ReplenishVerifier-FullV2, ReplenishVerifier-HybridSafe, ReplenishVerifier-TypeAware, Structure only

## Alias-like same-selection pairs

| method_a | method_b | same_selection_rate | objective_accuracy | recommendation |
| --- | --- | ---: | ---: | --- |
| ReplenishVerifier-ConsensusSafe | ReplenishVerifier-HybridSafe | 1.0000 | 0.81 | alias_like_same_selection |

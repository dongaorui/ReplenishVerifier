...
STRUCTURE_KEYS = [
    ...
    "big_m_constraint",
    "lead_time",
    "service_level_constraint",
    "moq_constraint",
    "batch_integer_variable",
    "batch_linking_constraint",
    "order_cost",
    "holding_cost",
    "shortage_cost",
    "fixed_order_cost",
...
EXPECTED_STRUCTURES_BY_TYPE = {
    ...
    "single_item_multi_period_lead_time": {
        ...
        "optional": {"shortage_variable", "shortage_cost"},
        "forbidden": set(),
    },
    ...
    "single_item_multi_period_moq_batch": {
        ...
        "optional": {"big_m_constraint", "fixed_order_cost"},
        "forbidden": set(),
    },
}
